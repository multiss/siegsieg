(function e(h, j, l) {
    ...
    2: [function(g, k, h) {
        ...
        "./data": 4,
        "@marcom/ac-polyfills/Array/prototype.filter": 45,
        "@marcom/ac-polyfills/Array/prototype.some": 49
    }],
    3: [function(d, g, f) {
        g.exports = {
    ...
    21: [function(z, C, x) {
        ...
        "@marcom/ac-dom-nodes/COMMENT_NODE": 7,
        "@marcom/ac-dom-nodes/DOCUMENT_FRAGMENT_NODE": 8,
        "@marcom/ac-dom-nodes/DOCUMENT_NODE": 9,
        "@marcom/ac-dom-nodes/ELEMENT_NODE": 10,
        "@marcom/ac-dom-nodes/TEXT_NODE": 11,
        "@marcom/ac-dom-nodes/isNode": 17,
        "@marcom/ac-polyfills/Array/prototype.indexOf": 47
    }],
    22: [function(p, o, q) {
        ...
        "./internal/nativeMatches": 20,
        "./internal/validate": 21,
        "./shims/matchesSelector": 26,
        "@marcom/ac-dom-nodes/isElement": 16
    }],
    23: [function(o, n, i) {
    ...
    25: [function(i, o, j) {
        ...
        "./internal/validate": 21,
        "./shims/querySelectorAll": 28,
        "@marcom/ac-polyfills/Array/prototype.slice": 48
    }],
    26: [function(k, j, g) {
    ...
    28: [function(s, t, q) {
        ...
        "@marcom/ac-dom-nodes/isDocumentFragment": 15,
        "@marcom/ac-dom-nodes/isElement": 16,
        "@marcom/ac-dom-nodes/remove": 18,
        "@marcom/ac-polyfills/Array/prototype.indexOf": 47
    }],
    29: [function(d, g, f) {
        g.exports = {
    ...
    34: [function(k, j, g) {
        ...
        "@marcom/ac-polyfills/Array/prototype.forEach": 46
    }],
    35: [function(t, u, q) {
        t("@marcom/ac-polyfills/Function/prototype.bind");
        var s = t("@marcom/ac-object/defaults");
        var m = t("@marcom/ac-dom-traversal/querySelector");
        var w = t("@marcom/ac-dom-traversal/querySelectorAll");
        var r = t("@marcom/ac-dom-traversal/nextSibling");
        var o = t("./internal/CheckboxMenu");
        var v = {
            className: "footer"
        };
        ...
        function n(b, a) {
            ...
            this._selectors = {
                wrapper: "." + a.className,
                directory: a.directorySelector || "." + a.className + "-directory",
                mini: a.miniSelector || "." + a.className + "-mini"
            };
            this._initializeDirectory();
            this._initializeLangLink()
        }
        var p = n.prototype;
        p._initializeDirectory = function() {
            this._directory = m(this._selectors.directory, this.el);
            if (!this._directory) {
                return
            }
            var c = w(this._selectors.directory + "-column-section-state", this.directory);
            var b;
            var a;
            var d;
            for (var f = 0; f < c.length; f++) {
                b = r(c[f]);
                a = m(this._selectors.directory + "-column-section-anchor-open", b);
                d = m(this._selectors.directory + "-column-section-anchor-close", b);
                o.create(c[f], a, d)
            }
        };
        p._initializeLangLink = function() {
            var c;
            var b;
            var a;
            this._langLink = m(this._selectors.mini + "-locale-lang", this.el);
            if (!this._langLink) {
                return
            }
            c = window.location.pathname;
            b = this._langLink.getAttribute("data-locale-current");
            a = this._langLink.pathname;
            if (c.indexOf(b) !== -1) {
                c = c.replace(b, a);
                if (c.charAt(0) !== "/") {
                    c = "/" + c
                }
                this._langLink.href = c
            }
        };
        u.exports = n
    }, {
        "./internal/CheckboxMenu": 36,
        "@marcom/ac-dom-traversal/nextSibling": 23,
        "@marcom/ac-dom-traversal/querySelector": 24,
        "@marcom/ac-dom-traversal/querySelectorAll": 25,
        "@marcom/ac-object/defaults": 33,
        "@marcom/ac-polyfills/Function/prototype.bind": 51
    }],
    36: [function(n, m, i) {
        n("@marcom/ac-polyfills/Function/prototype.bind");
        var j = n("@marcom/ac-dom-events/utils/addEventListener");
        var o = n("@marcom/ac-dom-events/preventDefault");
        ...
        function k(b, c, a) {
            ...
            j(this.el, "change", this.update.bind(this));
            j(this.anchorOpen, "click", this._anchorOpenClick.bind(this));
            j(this.anchorClose, "click", this._anchorCloseClick.bind(this));
            if (window.location.hash === "#" + b.id) {
                window.location.hash = ""
            }
        }
        k.create = function(b, c, a) {
            return new k(b, c, a)
        };
        var l = k.prototype;
        l.update = function() {
        ...
        l._anchorOpenClick = function(a) {
            o(a);
            this.open();
            this.anchorClose.focus()
        };
        l._anchorCloseClick = function(a) {
            o(a);
            this.close();
        ...
        "@marcom/ac-dom-events/preventDefault": 5,
        "@marcom/ac-dom-events/utils/addEventListener": 6,
        "@marcom/ac-polyfills/Function/prototype.bind": 51
    }],
    37: [function(j, p, k) {
        ...
        "@marcom/ac-classlist/add": 38,
        "@marcom/ac-classlist/remove": 43,
    ...
    53: [function(g, k, h) {
        ...
        var i = g("./ac-globalfooter/GlobalFooter");
        var j = document.getElementById("ac-globalfooter");
        if (j) {
            k.exports = new i(j)
        }
    }, {
        "./ac-globalfooter/GlobalFooter": 54,
        "@marcom/ac-polyfills/String/prototype.trim": 52
    }],
    54: [function(C, D, B) {
        C("@marcom/ac-polyfills/Function/prototype.bind");
        var u = C("@marcom/ac-footer/Footer");
        var s = C("@marcom/ac-headjs/FeatureDetect");
        var q = C("./featureDetectTests");
        var r = C("@marcom/ac-dom-traversal/querySelector");
        var E = C("@marcom/ac-dom-traversal/querySelectorAll");
        var y = C("@marcom/ac-dom-events/utils/addEventListener");
        var w = C("@marcom/ac-dom-events/preventDefault");
        var A = C("@marcom/ac-dom-nodes/insertFirstChild");
        var x = C("@marcom/ac-dom-nodes/replace");
        var v = function(a) {
            var b = new s(a, q);
            b.htmlClass();
            u.call(this, a, {
        ...
        var t = u.prototype;
        var z = v.prototype = Object.create(t);
        v.prototype.constructor = v;
        z._initializeBuyStrip = function() {
            var b;
            var a;
            this._buystrip = r(".ac-gf-buystrip");
            if (!this._buystrip) {
                return
            }
            b = E(".ac-gf-buystrip-info-content", this._buystrip);
            for (a = 0; a < b.length; a++) {
                this._makeBlockLink(b[a])
            }
        };
        z._initializeChatLink = function() {
            var a;
            if (this._buystrip) {
                this._chatLink = r(".ac-gf-buystrip-info-cta-chat", this._buystrip);
                if (this._chatLink) {
                    a = this._chatLink.parentNode;
                    if (a.href) {
                        this._chatLink = a
                    }
                    this._onChatLinkClick = this._onChatLinkClick.bind(this);
                    y(this._chatLink, "click", this._onChatLinkClick)
                }
            }
        };
        z._onChatLinkClick = function(a) {
            w(a);
            window.open(this._chatLink.href, "chat", "width=375,height=773")
        };
        z._makeBlockLink = function(d) {
            var b;
            var f;
            var a;
            var c;
            ...
            a.className = "ac-gf-block";
            a.href = b.href;
            f = document.createElement("span");
            f.className = b.className + " ac-gf-block-link";
            f.innerHTML = b.innerHTML;
            b.parentNode.className += " with-cta";
            x(f, b);
            A(a, d);
        ...
        "./featureDetectTests": 55,
        "@marcom/ac-dom-events/preventDefault": 5,
        "@marcom/ac-dom-events/utils/addEventListener": 6,
        "@marcom/ac-dom-nodes/insertFirstChild": 12,
        "@marcom/ac-dom-nodes/replace": 19,
        "@marcom/ac-dom-traversal/querySelector": 24,
        "@marcom/ac-dom-traversal/querySelectorAll": 25,
        "@marcom/ac-footer/Footer": 35,
        "@marcom/ac-headjs/FeatureDetect": 37,
        "@marcom/ac-polyfills/Function/prototype.bind": 51
    }],
    55: [function(l, k, m) {
        ...
        "@marcom/ac-browser": 1,
        "@marcom/ac-feature/svgAvailable": 31,
        "@marcom/ac-feature/touchAvailable": 32
    }]
}, {}, [53]);
