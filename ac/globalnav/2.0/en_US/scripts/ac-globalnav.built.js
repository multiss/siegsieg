(function e(h, j, l) {
    ...
    2: [function(g, k, h) {
        ...
        "./data": 4,
        "@marcom/ac-polyfills/Array/prototype.filter": 70,
    ...
    5: [function(g, k, h) {
        ...
        "@marcom/ac-polyfills/Element/prototype.classList": 76
    }],
    6: [function(d, g, f) {
        g.exports = {
            add: d("./className/add"),
    ...
    16: [function(p, r, o) {
        ...
        "./shared/camelCasedEventTypes": 17,
        "./shared/prefixHelper": 18,
        "./shared/windowFallbackEventTypes": 19,
        "./utils/eventTypeAvailable": 20
    }],
    17: [function(d, g, f) {
        g.exports = {
    ...
    22: [function(k, i, g) {
        ...
        "@marcom/ac-prefixer/getEventType": 16
    }],
    23: [function(i, h, f) {
    ...
    39: [function(o, n, i) {
        ...
        "./internal/validate": 41,
        "./matchesSelector": 42,
        "@marcom/ac-dom-nodes/isElement": 36
    }],
    40: [function(d, g, f) {
    ...
    41: [function(z, C, x) {
        ...
        "@marcom/ac-dom-nodes/COMMENT_NODE": 27,
        "@marcom/ac-dom-nodes/DOCUMENT_FRAGMENT_NODE": 28,
        "@marcom/ac-dom-nodes/DOCUMENT_NODE": 29,
        "@marcom/ac-dom-nodes/ELEMENT_NODE": 30,
        "@marcom/ac-dom-nodes/TEXT_NODE": 31,
        "@marcom/ac-dom-nodes/isNode": 37,
        "@marcom/ac-polyfills/Array/prototype.indexOf": 72
    }],
    42: [function(p, o, q) {
        ...
        "./internal/nativeMatches": 40,
        "./internal/validate": 41,
        "./shims/matchesSelector": 45,
        "@marcom/ac-dom-nodes/isElement": 36
    }],
    43: [function(o, n, j) {
        var k = o("./internal/validate");
    ...
    47: [function(s, t, q) {
        ...
        "@marcom/ac-dom-nodes/isDocumentFragment": 35,
        "@marcom/ac-dom-nodes/isElement": 36,
        "@marcom/ac-dom-nodes/remove": 38,
        "@marcom/ac-polyfills/Array/prototype.indexOf": 72
    }],
    48: [function(d, g, f) {
        g.exports = {
    ...
    50: [function(o, n, i) {
        ...
        "@marcom/ac-function/memoize": 64,
        "@marcom/ac-prefixer/getStyleProperty": 53,
        "@marcom/ac-prefixer/getStyleValue": 54
    }],
    51: [function(d, g, f) {
        g.exports = {
            getWindow: function() {
    ...
    52: [function(m, l, h) {
        ...
        "./helpers/globals": 51,
        "@marcom/ac-function/once": 65,
        "@marcom/ac-polyfills/matchMedia": 82
    }],
    53: [function(q, r, o) {
        ...
        "./shared/getStyleTestElement": 55,
        "./shared/prefixHelper": 56,
        "./shared/stylePropertyCache": 57,
        "./utils/toCSS": 59,
        "./utils/toDOM": 60
    }],
    54: [function(t, v, q) {
    ...
    58: [function(s, t, r) {
        ...
        "./getStyleTestElement": 55,
        "./stylePropertyCache": 57
    }],
    59: [function(k, j, g) {
    ...
    67: [function(o, n, i) {
        ...
        "./extend": 68,
        "@marcom/ac-polyfills/Array/isArray": 69
    }],
    68: [function(k, j, g) {
        ...
        "@marcom/ac-polyfills/Array/prototype.forEach": 71
    }],
    69: [function(d, g, f) {
        if (!Array.isArray) {
    ...
    84: [function(t, u, r) {
        ...
        var l = t("@marcom/ac-event-emitter-micro").EventEmitterMicro;
        var o = t("@marcom/ac-dom-events/utils/addEventListener");
        var p = t("@marcom/ac-feature/mediaQueriesAvailable");
        ...
        function m(a) {
            ...
            if (p()) {
                ...
                o(window, "resize", this._update);
                o(window, "orientationchange", this._update)
            }
            this._update()
        }
        var q = m.prototype = Object.create(l.prototype);
        q.viewport = false;
        q._initializeElement = function(a) {
            var b;
            a = a || s;
        ...
        q._update = function() {
            ...
            if (b && this.viewport !== b) {
                c = {
                    from: b,
                    to: this.viewport
                };
                this.trigger("change", c);
                this.trigger("from:" + b, c);
                this.trigger("to:" + this.viewport, c)
            }
        };
        q._invalidateStyles = function() {
        ...
        "@marcom/ac-dom-events/utils/addEventListener": 25,
        "@marcom/ac-event-emitter-micro": 48,
        "@marcom/ac-feature/mediaQueriesAvailable": 52,
        "@marcom/ac-polyfills/Function/prototype.bind": 77,
        "@marcom/ac-polyfills/Object/create": 79,
        "@marcom/ac-polyfills/Object/keys": 80
    }],
    85: [function(P, U, A) {
    ...
    87: [function(i, m, j) {
        ...
        var o = {
            ajax: function(c, b) {
                ...
                var a = l(c);
                a.open(b.method, c);
                a.setTransportHeaders(b.headers);
                a.setReadyStateChangeHandlers(b.complete, b.error, b.success);
                a.setTimeout(b.timeout, b.error, b.complete);
                a.send(b.data);
                return a
            },
            get: function(b, a) {
    ...
    88: [function(q, r, o) {
        var k = q("./xmlhttprequest");
        var l = q("./xdomainrequest");
        var m = /.*(?=:\/\/)/;
        var s = /^.*:\/\/|\/.+$/g;
        var p = window.XDomainRequest && document.documentMode < 10;
        var n = function(a) {
            if (!a.match(m)) {
                return false
            }
    ...
    89: [function(f, h, g) {
        ...
        i.prototype.setTimeout = function(a, b, c) {
            this.xhr.ontimeout = function() {
                b(this.xhr, this.status);
                c(this.xhr, this.status)
            }.bind(this)
        };
        i.prototype.setTransportHeaders = function(b) {
            for (var a in b) {
                this.xhr.setRequestHeader(a, b[a])
            }
        };
        h.exports = i
    }, {}],
    90: [function(h, k, i) {
        var l = h("./request");
        var m = h("ac-object/toQueryParameters");
        var j = function() {
            this.xhr = new XDomainRequest()
        };
        j.prototype = l.create();
        j.prototype.setReadyStateChangeHandlers = function(c, b, a) {
            this.xhr.onerror = function() {
                b(this.xhr, this.status);
                c(this.xhr, this.status)
            }.bind(this);
            this.xhr.onload = function() {
                a(this.xhr.responseText, this.xhr.status, this.xhr);
                c(this.xhr, this.status)
            }.bind(this)
        };
        ...
        j.prototype.setTransportHeaders = function(a) {};
        k.exports = j
    }, {
        "./request": 89,
        "ac-object/toQueryParameters": 86
    }],
    91: [function(g, j, h) {
        var k = g("./request");
        var i = function() {
        ...
        i.prototype.setReadyStateChangeHandlers = function(c, b, a) {
            this.xhr.onreadystatechange = function(d) {
    ...
    93: [function(d, g, f) {
        ...
        "./ac-event-emitter-micro/EventEmitterMicro": 94
    }],
    94: [function(g, k, h) {
        function i() {
            this._events = {}
    ...
    95: [function(d, g, f) {
        ...
        "./ac-shared-instance/SharedInstance": 96
    }],
    96: [function(p, m, q) {
        var l = window,
            n = "AC",
    ...
    101: [function(k, j, g) {
        ...
        "ac-polyfills/Array/prototype.forEach": 102
    }],
    102: [function(f, i, g) {
        if (!Array.prototype.forEach) {
            Array.prototype.forEach = function h(a, b) {
    ...
    103: [function(d, g, f) {
        ...
        "./ac-mvc-model/Model": 104
    }],
    104: [function(o, s, n) {
        var k = o("ac-event-emitter-micro").EventEmitterMicro;
        var r = o("ac-object/defaults");
        var l = o("ac-object/create");
        var q = o("ac-mvc-cid").CID;
        var p = function(a) {
            k.call(this);
            this.attributes = r(this.defaultAttributes, a || {});
            this.cid = q.getNewCID();
            if (this.attributes[this.idAttribute]) {
                this.id = this.attributes[this.idAttribute]
            }
        };
        var m = p.prototype = l(k.prototype);
        m.defaultAttributes = {};
        m.idAttribute = "id";
        m._trigger = function(a, b, c) {
            c = c || {};
            if (c.silent !== true) {
                this.trigger(a, b)
            }
        };
        m._triggerChange = function(a, b, c) {
        ...
        m.set = function(b, c) {
            ...
            for (f in b) {
                if (b.hasOwnProperty(f)) {
                    h = this.get(f);
                    if ((typeof h === "object" && typeof b[f] === "object" && JSON.stringify(h) === JSON.stringify(b[f])) || (h === b[f])) {
                        continue
                    }
                    d = true;
                    this.attributes[f] = b[f];
                    g = {
                        value: b[f],
                        previous: h
                    };
                    a[f] = g;
                    this._triggerChange(f, g, c)
                }
            }
            if (d) {
        ...
        "ac-event-emitter-micro": 93,
        "ac-mvc-cid": 97,
        "ac-object/create": 99,
        "ac-object/defaults": 100
    }],
    105: [function(d, g, f) {
        (function() {
            var b = typeof f != "undefined" ? f : this;
            ...
            b.btoa || (b.btoa = function(q) {
                var u = String(q);
                for (var o, s, t = 0, p = a, r = ""; u.charAt(t | 0) || (p = "=", t % 1); r += p.charAt(63 & o >> 8 - t % 1 * 8)) {
                    s = u.charCodeAt(t += 3 / 4);
                    if (s > 255) {
            ...
            b.atob || (b.atob = function(q) {
                var u = String(q).replace(/=+$/, "");
                if (u.length % 4 == 1) {
                    throw new c("'atob' failed: The string to be decoded is not correctly encoded.")
                }
                for (var o = 0, p, s, t = 0, r = ""; s = u.charAt(t++); ~s && (p = o % 4 ? p * 64 + s : s, o++ % 4) ? r += String.fromCharCode(255 & p >> (-2 * o & 6)) : 0) {
                    s = a.indexOf(s)
                }
                return r
            })
    ...
    106: [function(d, g, f) {
        arguments[4][93][0].apply(f, arguments)
    }, {
        "./ac-event-emitter-micro/EventEmitterMicro": 107,
        dup: 93
    }],
    107: [function(d, g, f) {
        arguments[4][94][0].apply(f, arguments)
    }, {
        dup: 94
    }],
    108: [function(f, i, g) {
    ...
    134: [function(l, k, m) {
        ...
        "./ELEMENT_NODE": 131,
        "./internal/isNodeType": 142,
        "ac-polyfills/Array/prototype.filter": 108,
        "ac-polyfills/Array/prototype.slice": 110
    }],
    135: [function(i, h, g) {
        h.exports = function f(a, b) {
            if ("hasAttribute" in a) {
    ...
    136: [function(d, g, f) {
        ...
        "./COMMENT_NODE": 127,
        "./DOCUMENT_FRAGMENT_NODE": 128,
        "./DOCUMENT_NODE": 129,
        "./DOCUMENT_TYPE_NODE": 130,
        "./ELEMENT_NODE": 131,
        "./TEXT_NODE": 132,
        "./createDocumentFragment": 133,
        "./filterByNodeType": 134,
        "./hasAttribute": 135,
        "./indexOf": 137,
        "./insertAfter": 138,
        "./insertBefore": 139,
        "./insertFirstChild": 140,
        "./insertLastChild": 141,
        "./isComment": 144,
        "./isDocument": 145,
        "./isDocumentFragment": 146,
        "./isDocumentType": 147,
        "./isElement": 148,
        "./isNode": 149,
        "./isNodeList": 150,
    ...
    137: [function(m, l, h) {
        m("ac-polyfills/Array/prototype.indexOf");
        m("ac-polyfills/Array/prototype.slice");
        ...
        "./filterByNodeType": 134,
        "./internal/validate": 143,
        "ac-polyfills/Array/prototype.indexOf": 109,
        "ac-polyfills/Array/prototype.slice": 110
    }],
    138: [function(g, k, h) {
    ...
    154: [function(k, i, g) {
        ...
        "./ac-feature/cssPropertyAvailable": 155,
        "./ac-feature/localStorageAvailable": 156
    }],
    155: [function(o, m, i) {
        var l = null;
        var k = null;
    ...
    157: [function(d, g, f) {
        arguments[4][85][0].apply(f, arguments)
    }, {
        dup: 85
    }],
    158: [function(d, g, f) {
        ...
        "./ac-object/clone": 159,
        "./ac-object/create": 160,
        "./ac-object/defaults": 161,
        "./ac-object/extend": 162,
        "./ac-object/getPrototypeOf": 163,
        "./ac-object/isDate": 164,
        "./ac-object/isEmpty": 165,
        "./ac-object/isRegExp": 166,
        "./ac-object/toQueryParameters": 167
    }],
    159: [function(g, k, h) {
        var i = g("./extend");
        k.exports = function j(a) {
    ...
    160: [function(d, g, f) {
        arguments[4][99][0].apply(f, arguments)
    }, {
        dup: 99
    }],
    161: [function(d, g, f) {
        arguments[4][100][0].apply(f, arguments)
    }, {
        "./extend": 162,
        dup: 100
    }],
    ...
    167: [function(d, g, f) {
        arguments[4][86][0].apply(f, arguments)
    }, {
        dup: 86,
        qs: 157
    }],
    168: [function(p, n, k) {
        ...
        "./ac-storage/Item": 169,
        "./ac-storage/Storage": 176,
        "./ac-storage/Storage/storageAvailable": 178
    }],
    169: [function(t, v, o) {
        var w = t("ac-checksum").adler32;
        var p = t("ac-object");
        var n = t("./Item/apis");
        ...
        "./Item/apis": 170,
        "./Item/createExpirationDate": 173,
        "./Item/encoder": 174,
        "ac-checksum": 123,
        "ac-object": 158
    }],
    170: [function(n, l, i) {
        var k = n("ac-console").log;
    ...
    176: [function(n, m, p) {
        ...
        "./Item/apis/localStorage": 171,
        "./Storage/registry": 177,
        "ac-object": 158
    }],
    177: [function(k, j, m) {
        var l = k("../Item");
    ...
    179: [function(A, B, y) {
        A("ac-polyfills/Promise");
        A("ac-polyfills/Object/create");
        var x = null;
        try {
            x = A("ac-storage")
        } catch (v) {}
        var q = A("ac-event-emitter-micro").EventEmitterMicro;
        var s = A("mustache");
        var w = A("Base64");
        var E = A("./cookie.js");
        var u = "ac-store-cache";
        var r = {
            items: A("../mustache/items.mustache")
        };
        var C = {
            getItem: function(b) {
                var c = null;
        ...
        var z = function(m, l, a, aa) {
            ...
            var p = function p(H, G) {
                var J;
                var I = d[H];
                var F = I !== G;
                if (F && typeof I === "object" && G === "object") {
                    F = false;
                    for (J in G) {
                        F = F || G[J] !== I[J]
                    }
                ...
                if (F) {
                    d[H] = G;
                    V.trigger(H + "Change", G)
                }
            };
            var h = function h(H, F, J) {
                var I = (H.indexOf("?") === -1 ? "?" : "&");
                var G = /(%5B|\[)storefront(%5D|\])/g;
                H = H.replace(G, F.storefront || l);
                H = H.indexOf("//") === 0 ? window.location.protocol + H : H;
                H += I + "apikey=" + encodeURIComponent(a);
                H += J ? "&l=" + encodeURIComponent(window.location + "") : "";
                return new Promise(function(O, K) {
                    try {
                        ...
                        L.onreadystatechange = function M() {
                            if (L.readyState === 4) {
                                try {
                                    var P = JSON.parse(L.responseText);
                                    O(P)
                                } catch (ab) {
                                    K()
                                }
            ...
            var R = function() {
                var F = (window.decodeURIComponent(window.escape(w.atob(E.getAs("sfa") || ""))) || "").split("|");
                var G = function G(H) {
                    return F[0] === "2" && H === 9 ? F[2] : F[0] === "2" && H > 1 ? F[H + 1] : F[H]
                };
                X = X || {
                    version: G(0),
                    storefront: G(1),
                    ...
                    segmentCode: G(4),
                    channelCode: G(5),
                    showBanner: G(6) === "1" || G(6) === "true",
                    persistBanner: G(7) === "1" || G(7) === "true",
                    bagEnabled: G(8) !== "0" && G(8) !== "false",
                    consumerStorefront: G(9)
                };
                return X
            };
            var f = function f() {
            ...
            var j = function j() {
                ...
                var F = true;
                var J = null;
                n = n || (f().then(function(K) {
                    var M = E.getAs("cn");
                    var L = K.storefront || l;
                    Y = Y || C.getItem(u);
                    I = K.bagEnabled;
                    F = K.showBanner;
                    H = Y && ((Q && Y.ttl === 0) || (G < Y.ttl && M === Y.cn && a === Y.key && L === Y.sfLoc));
                    return H || !I ? Promise.resolve() : h(aa, K, false).then(function(N) {
                        J = isNaN(parseInt(N.items, 10));
                        Y = {
                            ttl: (parseInt(N.ttl, 10) * 1000 + G) || 0,
                            items: !J ? parseInt(N.items, 10) : 0,
                            cn: M,
                            api: N.api,
                            key: a,
                            sfLoc: L
            ...
            var U = R();
            var o = U.consumerStorefront;
            if (!!o && !!l && o !== l) {
                T(true)
            }
            this.getStoreState = function b() {
                return j().then(function() {
                    return d.storeState
                })
            };
            this.getItemCount = function W() {
                return j().then(function() {
                    return d.itemCount
                })
            };
            this.__setItemCount = function S(F) {
                Z = null;
                p("itemCount", F);
                if (Y) {
                    Y.items = F;
            ...
            this.getStorefront = f;
            this.exitStorefront = T;
            this.addItem = function i(F) {
                return new Promise(function(G, H) {
                    this.trigger("itemAdded");
                    G()
                })
            };
            this.addFavorite = function g(F) {
                return new Promise(function(G, H) {
                    this.trigger("favoriteAdded");
                    G()
                })
            };
            this.updateBagFlyout = function k() {
                if (Z === null) {
                    m.innerHTML = s.render(r.items, {
                        loading: {
                            text: "Loading..."
                        }
                    });
                    Z = true;
                    (Y && Y.api ? Promise.resolve() : j()).then(f).then(function(H) {
                        var I = Y && Y.api && Y.api.flyout;
                        if (!I) {
                            throw "No Flyout API URL"
                        }
                        return h(I, H, true)
                    }).then(function F(I) {
                        Z = I || {};
                        Z.bag = Z.bag || {};
                        Z.bag.items = t(Z.bag.items);
                        Z.links = t(Z.links);
                        Z.promoLinks = t(Z.promoLinks);
                        Z.buttons = t(Z.buttons);
                        if (Z.bag.items.length === 0 && !Z.message) {
                            Z.message = {
                                type: "empty",
                                text: Z.bag.emptyBagMsg
                            }
                        }
                        if (Z.bag.extraItemsMsg) {
                            Z.lineMessage = {
                                text: Z.bag.extraItemsMsg
                            }
                        }
                        if (Z.links.length > 0) {
                            Z.navigation = {
                                noBtn: Z.buttons.length <= 0,
                                links: Z.links
                            }
                        }
                        if (Z.promoLinks.length > 0) {
                            Z.explodedPromoLinks = {
                                promoLinks: Z.promoLinks
                            }
                        }
                        for (var J = 0; J < Z.bag.items.length; J += 1) {
                            var H = Z.bag.items[J] || {};
                            H.qty = H.qty > 1 ? {
                                text: H.qty
                            } : false
                        }
                        m.innerHTML = s.render(r.items, Z)
                    }, function G() {
                        Z = null
                    })
                }
            };
            this.clearCache = function c(F) {
                if (!F || !Q) {
                    C.removeItem(u);
                    Y = null;
                    X = null;
        ...
        z.staticClearCache = function D() {
            C.removeItem(u)
        };
        B.exports = z
    }, {
        "../mustache/items.mustache": 181,
        "./cookie.js": 180,
        Base64: 105,
        "ac-event-emitter-micro": 106,
        "ac-polyfills/Object/create": 111,
        "ac-polyfills/Promise": 112,
        "ac-storage": 168,
        mustache: 182
    }],
    180: [function(o, n, q) {
        var j = function j(b) {
            var c = encodeURIComponent(b).replace(/[\-\.\+\*]/g, "\\$&");
            var a = new RegExp("(?:(?:^|.*;)\\s*" + c + "\\s*\\=\\s*([^;]*).*$)|^.*$");
            return decodeURIComponent(document.cookie.replace(a, "$1")) || null
        };
        var k = function k(b) {
            var a = window.cookieMap && window.cookieMap["as_" + b];
            return a ? j(a) : j("as_" + b) || j("as_" + b + "_stag") || j("as_" + b + "_qa1") || j("as_" + b + "_qa2") || j("as_" + b + "_qa3") || j("as_" + b + "_dev")
        };
        var l = function l(a) {
            var b = a && encodeURIComponent(a).replace(/[\-\.\+\*]/g, "\\$&");
        ...
        var p = function p(a, b, c) {
            if (window.envCookieSuffix) {
                m("as_" + a + window.envCookieSuffix, b, c)
            } else {
                m("as_" + a, b, c);
                m("as_" + a + "_stag", b, c);
                m("as_" + a + "_qa1", b, c);
    ...
    182: [function(k, j, g) {
         ...
         */
        (function h(a, b) {
            if (typeof g === "object" && g && typeof g.nodeName !== "string") {
                b(g)
            } else {
            ...
            var aj = Object.prototype.toString;
            var ai = Array.isArray || function aE(l) {
                return aj.call(l) === "[object Array]"
            };
            ...
            function X(m, l) {
                return m != null && typeof m === "object" && (l in m)
            }
            var at = RegExp.prototype.test;
            ...
            function ah(l) {
                return String(l).replace(/[&<>"'`=\/]/g, function m(n) {
                    return aq[n]
                })
            }
            var an = /\s*/;
            ...
            function aD(q, B) {
                ...
                function D(G) {
                    ...
                    if (!ai(G) || G.length !== 2) {
                        throw new Error("Invalid tags: " + G)
                    }
                    x = new RegExp(az(G[0]) + "\\s*");
                    C = new RegExp("\\s*" + az(G[1]));
                    r = new RegExp("\\s*" + az("}" + G[1]))
                }
                D(B || ab.tags);
                var m = new aH(q);
                var l, n, y, v, F, o;
                while (!m.eos()) {
                    ...
                    if (n === "#" || n === "^") {
                        ...
                        if (n === "/") {
                            o = z.pop();
                            if (!o) {
                                throw new Error('Unopened section "' + y + '" at ' + l)
                            }
                            if (o[1] !== y) {
                                throw new Error('Unclosed section "' + o[1] + '" at ' + l)
                            }
                        } else {
                            if (n === "name" || n === "{" || n === "&") {
                                s = true
            ...
            aH.prototype.eos = function W() {
                return this.tail === ""
            };
            aH.prototype.scan = function b(m) {
                var n = this.tail.match(m);
                if (!n || n.index !== 0) {
                    return ""
                }
                var l = n[0];
            ...
            aH.prototype.scanUntil = function Y(m) {
                var n = this.tail.search(m),
                    l;
                switch (n) {
                    case -1:
                        l = this.tail;
            ...
            d.prototype.push = function aa(l) {
                return new d(l, this)
            };
            d.prototype.lookup = function ay(p) {
                var r = this.cache;
                var n;
            ...
            ax.prototype.clearCache = function ag() {
                this.cache = {}
            };
            ax.prototype.parse = function al(n, o) {
                var l = this.cache;
                var m = l[n];
                if (m == null) {
                    m = l[n] = aD(n, o)
            ...
            ax.prototype.render = function af(n, l, o) {
                var m = this.parse(n);
                var p = (l instanceof d) ? l : new d(l);
                return this.renderTokens(m, p, o, n)
            };
            ax.prototype.renderTokens = function au(s, p, u, q) {
                var m = "";
                var n, o, r;
                for (var l = 0, t = s.length; l < t; ++l) {
                    r = undefined;
                    n = s[l];
                    o = n[0];
                    if (o === "#") {
                        r = this.renderSection(n, p, u, q)
                    } else {
                        if (o === "^") {
                            r = this.renderInverted(n, p, u, q)
                        } else {
                            if (o === ">") {
                                r = this.renderPartial(n, p, u, q)
                            } else {
                                if (o === "&") {
                                    r = this.unescapedValue(n, p)
                                } else {
                                    if (o === "name") {
                                        r = this.escapedValue(n, p)
                                    } else {
                                        if (o === "text") {
                                            r = this.rawValue(n)
                                        }
            ...
            ax.prototype.renderSection = function ak(n, p, u, r) {
                var q = this;
                var l = "";
                var t = p.lookup(n[1]);

                function o(v) {
                    return q.render(v, p, u)
                }
                if (!t) {
                    return
                }
                if (ai(t)) {
                    for (var m = 0, s = t.length; m < s; ++m) {
                        l += this.renderTokens(n[4], p.push(t[m]), u, r)
                    }
                } else {
                    if (typeof t === "object" || typeof t === "string" || typeof t === "number") {
                        l += this.renderTokens(n[4], p.push(t), u, r)
                    } else {
                        if (am(t)) {
                            if (typeof r !== "string") {
                                throw new Error("Cannot use higher-order sections without the original template")
                            }
                            t = t.call(p.view, r.slice(n[3], n[5]), o);
                            if (t != null) {
                                l += t
                            }
                        } else {
                            l += this.renderTokens(n[4], p, u, r)
                        }
                    }
                }
                return l
            };
            ax.prototype.renderInverted = function aG(o, p, l, n) {
                var m = p.lookup(o[1]);
                if (!m || (ai(m) && m.length === 0)) {
                    return this.renderTokens(o[4], p, l, n)
                }
            };
            ax.prototype.renderPartial = function Z(n, o, l) {
                if (!l) {
                    return
                }
                var m = am(l) ? l(n[1]) : l[n[1]];
                if (m != null) {
                    return this.renderTokens(this.parse(m), o, l, m)
                }
            };
            ax.prototype.unescapedValue = function aB(n, l) {
                var m = l.lookup(n[1]);
                if (m != null) {
                    return m
                }
            };
            ax.prototype.escapedValue = function ad(n, l) {
                var m = l.lookup(n[1]);
                if (m != null) {
                    return ab.escape(m)
                }
            };
            ax.prototype.rawValue = function aC(l) {
                return l[1]
            };
            ab.name = "http://images.apple.com/ac/globalnav/2.0/en_US/scripts/mustache.js";
            ab.version = "2.2.1";
            ab.tags = ["{{", "}}"];
            var a = new ax();
            ab.clearCache = function ag() {
                return a.clearCache()
            };
            ab.parse = function al(m, l) {
                return a.parse(m, l)
            };
            ab.render = function af(m, l, n) {
                if (typeof m !== "string") {
                    throw new TypeError('Invalid template! Template should be a "string" but "' + f(m) + '" was given as the first argument for mustache#render(template, view, partials)')
                }
                return a.render(m, l, n)
            };
            ab.to_html = function aA(n, p, o, m) {
                var l = ab.render(n, p, o);
                if (am(m)) {
                    m(l)
                } else {
                    return l
    ...
    183: [function(g, k, h) {
        g("@marcom/ac-polyfills/Function/prototype.bind");
        g("@marcom/ac-polyfills/Object/create");
        g("@marcom/ac-polyfills/requestAnimationFrame");
        g("@marcom/ac-polyfills/String/prototype.trim");
        g("@marcom/ac-polyfills/Array/prototype.indexOf");
        g("@marcom/ac-polyfills/Array/prototype.some");
        g("@marcom/ac-polyfills/Array/isArray");
        g("@marcom/ac-polyfills/Array/prototype.forEach");
        var i = g("./ac-globalnav/GlobalNav");
        var j = new i()
    }, {
        "./ac-globalnav/GlobalNav": 184,
        "@marcom/ac-polyfills/Array/isArray": 69,
        "@marcom/ac-polyfills/Array/prototype.forEach": 71,
        "@marcom/ac-polyfills/Array/prototype.indexOf": 72,
        "@marcom/ac-polyfills/Array/prototype.some": 74,
        "@marcom/ac-polyfills/Function/prototype.bind": 77,
        "@marcom/ac-polyfills/Object/create": 79,
        "@marcom/ac-polyfills/String/prototype.trim": 81,
        "@marcom/ac-polyfills/requestAnimationFrame": 83
    }],
    184: [function(R, Z, M) {
        var I = R("ac-store");
        var W = R("./menu/CheckboxMenu");
        var ab = R("@marcom/ac-headjs/FeatureDetect");
        var D = R("./helpers/featureDetectTests");
        var V = R("@marcom/ac-dom-traversal/querySelector");
        var T = R("@marcom/ac-dom-events/utils/addEventListener");
        var Y = R("@marcom/ac-classlist");
        var E = R("@marcom/ac-browser");
        var S = R("@marcom/ac-dom-events/preventDefault");
        var Q = R("@marcom/ac-dom-events/stopPropagation");
        var C = R("@marcom/ac-dom-events/target");
        var F = R("./helpers/keyMap");
        var P = R("./helpers/ClickAway");
        var X = R("./search/SearchController");
        var L = R("./search/SearchReveal");
        var J = R("./segment/SegmentBar");
        var U = R("@marcom/ac-viewport-emitter/ViewportEmitter");
        var aa = R("./helpers/scrollSwitch");
        var ac = "with-bagview";
        var K = "with-badge";
        var G = "blocktransitions";
        var O = (E.os === "iOS" && E.version < 8);

        function N() {
            var a = document.getElementById("ac-globalnav");
            var b = new ab(a, D);
            this.el = a;
            this._viewports = new U("ac-gn-viewport-emitter");
            b.htmlClass();
        ...
        H._initializeFlyoutListeners = function() {
            T(window, "beforeunload", this._hideFlyouts.bind(this));
            T(window, "popstate", this._hideFlyouts.bind(this));
            T(document, "keydown", this._onBodyKeydown.bind(this));
            T(this.el, "keydown", this._onKeydown.bind(this));
            T(document.body, "focus", this._trapFocus.bind(this), true);
        ...
        H._onBodyKeydown = function(a) {
            if (a.keyCode === F.ESCAPE) {
        ...
        H._trapFocus = function(d) {
            var c = (this._bagVisible && this._viewports.viewport === "xsmall");
            var a;
            var b;
            if (this.menu.isOpen() || c || this._searchVisible) {
                a = C(d);
                if (!a.className.match(/\b(ac-gn-)/i)) {
                    S(d);
                    for (b = 0; b < this.firstFocusEl.length; b++) {
                        if (this.firstFocusEl[b]) {
                            this.firstFocusEl[b].focus()
                        }
                    }
                }
            }
        ...
        H._initializeMenu = function() {
            this.menu = new W(document.getElementById("ac-gn-menustate"), document.getElementById("ac-gn-menuanchor-open"), document.getElementById("ac-gn-menuanchor-close"));
        ...
        H._initializeStore = function() {
            ...
            c = document.getElementById("ac-gn-bag");
            if (!c) {
                return
            }
            this.bag = {};
            ...
            this.bag.link = V(".ac-gn-link-bag", this.bag.tab);
            this.bag.linkSmall = V(".ac-gn-link-bag", this.bag.tabSmall);
            this.bag.content = document.getElementById("ac-gn-bagview-content");
            this.bag.items = 0;
            this._bagVisible = false;
            this.store = new I(this.bag.content, this.attr.storeLocale, this.attr.storeKey, this.attr.storeAPI);
            window.acStore = this.store;
            var b = document.getElementById("ac-gn-segmentbar");
            if (b) {
                var a = ["SFX9YPYY9PPXCU9KH", "SJHJUH4YFCTTPD4F4", "SKCXTKATUYT9JK4HD", "SH2F4FDF44TAT2HTKDAJ7CJ2F97FXU7PP"];
                if (a.indexOf(this.attr.storeKey) !== -1) {
                    this.segment = new J(b, this.attr.storeLocale);
        ...
        H._onStoreResolve = function(a) {
            ...
            T(this.bag.link, "click", this.toggleBag);
            this._onBagMouseUp = this._onBagMouseUp.bind(this);
            T(this.bag.link, "mouseup", this._onBagMouseUp);
            if (this.bag.linkSmall) {
                T(this.bag.linkSmall, "click", this.toggleBag);
                T(this.bag.linkSmall, "mouseup", this._onBagMouseUp)
            }
            ...
            b = new P(".ac-gn-bag, .ac-gn-bagview");
            b.on("click", this.hideBag.bind(this))
        };
        H._onStoreReject = function() {};
        H._initializeSearch = function() {
            var a;
            this.searchOpenTrigger = V(".ac-gn-link-search", this.el);
            ...
            if (this.searchOpenTrigger) {
                ...
                T(this.searchOpenTrigger, "click", this.onSearchOpenClick.bind(this));
                T(this.searchCloseTrigger, "click", this.onSearchCloseClick.bind(this));
                T(this.searchCloseTrigger, "mouseup", this.onSearchCloseMouseUp.bind(this));
                T(window, "orientationchange", this._onSearchOrientationChange.bind(this));
                a = new P(".ac-gn-searchview, .ac-gn-link-search");
                a.on("click", this._onSearchClickAway.bind(this));
                this.searchController = new X(this.el, this.attr.searchLocale, this.attr.searchAPI);
        ...
        H._onViewportChange = function(b) {
            var c = (b.from === "medium" || b.to === "medium" || b.from === "large" || b.to === "large");
            var a = (b.from === "small" || b.to === "small" || b.from === "xsmall" || b.to === "xsmall");
            if (c && a) {
        ...
        H._blockTransitions = function() {
            Y.add(this.el, G);
            window.requestAnimationFrame(this._unblockTransitions.bind(this))
        };
        H._unblockTransitions = function() {
            Y.remove(this.el, G)
        };
        H._hideFlyouts = function() {
            this.hideSearch(true);
            this.menu.close()
        };
        H.onScrimClick = function() {
            if (this._searchVisible) {
                this.hideSearch()
            }
        };
        ...
        H._onBagMouseUp = function(a) {
            this.bag.link.blur();
            if (this.bag.linkSmall) {
                this.bag.linkSmall.blur()
            }
        };
        H.updateItemCount = function(a) {
            this.bag.items = a;
            if (a) {
                this.showBadge()
            } else {
        ...
        H.showBadge = function() {
            Y.add(this.bag.tab, K);
            Y.add(this.bag.tabSmall, K);
        ...
        H.hideBadge = function() {
            Y.remove(this.bag.tab, K);
            Y.remove(this.bag.tabSmall, K);
        ...
        H.onSearchOpenClick = function(a) {
        ...
        H.onSearchCloseClick = function(b) {
            var a = (this.searchCloseTrigger === document.activeElement);
            S(b);
            this.hideSearch();
            if (a) {
                this.searchOpenTrigger.focus()
        ...
        H.onSearchCloseMouseUp = function(a) {
            this.searchCloseTrigger.blur()
        };
        H._onSearchClickAway = function() {
            if (!this._isBreakpointWithMenu()) {
                this.hideSearch()
            }
        };
        H._onSearchOrientationChange = function() {
            if (this._searchVisible) {
                window.scrollTo(0, 0);
                if (O) {
        ...
        H.showSearch = function() {
            ...
            if (O && !this._isBreakpointWithMenu()) {
        ...
        H._onSearchHideEnd = function() {
            this._searchVisible = false;
            this.searchController.clearInput()
        };
        H._isBreakpointWithMenu = function() {
            return !!(this._viewports.viewport === "small" || this._viewports.viewport === "xsmall")
        };
        H._failSilently = function() {};
        Z.exports = N
    }, {
        "./helpers/ClickAway": 185,
        "./helpers/featureDetectTests": 186,
        "./helpers/keyMap": 187,
        ...
        "@marcom/ac-dom-events/preventDefault": 21,
        "@marcom/ac-dom-events/stopPropagation": 23,
        "@marcom/ac-dom-events/target": 24,
        "@marcom/ac-dom-events/utils/addEventListener": 25,
        "@marcom/ac-dom-traversal/querySelector": 43,
        "@marcom/ac-headjs/FeatureDetect": 66,
        "@marcom/ac-viewport-emitter/ViewportEmitter": 84,
        "ac-store": 179
    }],
    185: [function(q, r, p) {
        q("@marcom/ac-polyfills/Function/prototype.bind");
        var l = q("@marcom/ac-event-emitter-micro").EventEmitterMicro;
        var n = q("@marcom/ac-dom-events/utils/addEventListener");
        var s = q("@marcom/ac-dom-events/target");
        var k = q("@marcom/ac-dom-traversal/ancestors");

        function m(a) {
            l.call(this);
            this._selector = a;
            this._touching = false;
            n(document, "click", this._onClick.bind(this));
            n(document, "touchstart", this._onTouchStart.bind(this));
            n(document, "touchend", this._onTouchEnd.bind(this))
        }
        var o = m.prototype = Object.create(l.prototype);
        o._checkTarget = function(b) {
            var a = s(b);
            if (!k(a, this._selector, true).length) {
        ...
        "@marcom/ac-dom-events/target": 24,
        "@marcom/ac-dom-events/utils/addEventListener": 25,
        "@marcom/ac-dom-traversal/ancestors": 39,
        "@marcom/ac-event-emitter-micro": 48,
        "@marcom/ac-polyfills/Function/prototype.bind": 77
    }],
    186: [function(l, k, m) {
        var j = l("@marcom/ac-browser");
        var i = l("@marcom/ac-feature/touchAvailable");
        var h = l("@marcom/ac-feature/svgAvailable");
        k.exports = {
            touch: i,
            svg: h,
            ie7: (j.IE && j.IE.documentMode === 7),
            ie8: (j.IE && j.IE.documentMode === 8)
        }
    }, {
        "@marcom/ac-browser": 1,
        "@marcom/ac-feature/svgAvailable": 61,
        "@marcom/ac-feature/touchAvailable": 62
    }],
    187: [function(d, g, f) {
        g.exports = {
            BACKSPACE: 8,
    ...
    188: [function(x, y, t) {
        var v = x("@marcom/ac-classlist");
        var q = x("@marcom/ac-browser");
        var o = x("@marcom/ac-dom-traversal/querySelector");
        var u = "ac-gn-noscroll";
        var n = "ac-gn-noscroll-long";
        var p = ", maximum-scale=1, user-scalable=0";
        var s = null;
        var w;
        var r = function() {
            if (s === null) {
                s = false;
                if (q.name === "Android" || (q.os === "iOS" && parseInt(q.version, 10) < 8)) {
                    w = o("meta[name=viewport]");
                    if (w) {
                        s = true
                    }
                }
        ...
        y.exports = {
            lock: function() {
                var a = (document.body.scrollHeight > document.documentElement.clientWidth);
                v.add(document.documentElement, u);
                v.toggle(document.documentElement, n, a);
                if (r()) {
                    w.setAttribute("content", w.getAttribute("content") + p)
                }
            },
            unlock: function() {
                v.remove(document.documentElement, u);
                v.remove(document.documentElement, n);
                if (r()) {
                    w.setAttribute("content", w.getAttribute("content").replace(p, ""))
                }
            }
        }
    }, {
    ...
    189: [function(p, o, j) {
        var l = p("@marcom/ac-event-emitter-micro").EventEmitterMicro;
        var k = p("@marcom/ac-dom-events/utils/addEventListener");
        var q = p("@marcom/ac-dom-events/preventDefault");
        ...
        function m(b, c, a) {
            ...
            k(this.el, "change", this.update.bind(this));
            k(this.anchorOpen, "click", this._anchorOpenClick.bind(this));
            k(this.anchorClose, "click", this._anchorCloseClick.bind(this));
        ...
        n._anchorOpenClick = function(a) {
            q(a);
            this.open();
            this.anchorClose.focus()
        };
        n._anchorCloseClick = function(a) {
            q(a);
            this.close();
    ...
    190: [function(C, D, B) {
        var z = C("@marcom/ac-dom-events/utils/addEventListener");
        var r = C("@marcom/ac-dom-traversal/querySelector");
        var s = C("@marcom/ac-function/debounce");
        var x = C("@marcom/ac-dom-events/preventDefault");
        var v = C("./guid");
        var q = C("./SearchFormController");
        var t = C("./results/SearchResultsSelectionController");
        var w = C("./results/SearchResultsView");
        var E = C("./results/SearchModel");
        var y = C("../helpers/keyMap");
        ...
        function u(b, c, a) {
            ...
            z(this.searchForm, "submit", this._onFormSubmit.bind(this));
            this.searchID = v();
            this.searchResultsModel = new E(a);
            this.searchResultsModel.on("change", this._onModelChange.bind(this));
            this.fetchDataLazy = s(this.fetchData, 100);
            this.searchFormController = new q(this.searchView);
            ...
            this.selectionController = new t(this.searchResults);
            this.selectionController.on("change", this._onSelectionChange.bind(this));
            this.searchResultsView = new w(this.searchResults)
        }
        var A = u.prototype;
        A._onFormSubmit = function(b) {
            var a = this.selectionController.getSelected();
            if (a && !a.hover) {
                x(b);
                this.selectionController.goToSelected()
            }
        };
        A._onKeydown = function(b) {
            var a = b.originalEvent.keyCode;
            if (a === y.ENTER) {
                this._onFormSubmit(b.originalEvent)
            }
        };
        A._onKeyup = function(a) {
            this.selectionController.onKeyup(a.originalEvent)
        };
        A._onModelChange = function() {
            this.searchResultsView.render(this.searchResultsModel.attributes);
            this.selectionController.updateSelectableItems()
        };
        A._onInputChange = function() {
            this.fetchDataLazy()
        };
        A._onInputBlur = function() {
            this.selectionController.setSelected()
        };
        A._onSelectionChange = function(a) {
            this.searchFormController.setAutocomplete(a)
        };
        ...
        "@marcom/ac-dom-events/utils/addEventListener": 25,
        "@marcom/ac-dom-traversal/querySelector": 43,
        "@marcom/ac-function/debounce": 63
    }],
    191: [function(w, x, u) {
        var v = w("@marcom/ac-classlist");
        var p = w("@marcom/ac-dom-traversal/querySelector");
        var s = w("@marcom/ac-dom-events/utils/addEventListener");
        var y = w("@marcom/ac-dom-events/utils/removeEventListener");
        var q = w("@marcom/ac-dom-events/preventDefault");
        var n = w("@marcom/ac-event-emitter-micro").EventEmitterMicro;
        var r = w("../helpers/keyMap");
        ...
        function o(a) {
            ...
            s(this.searchForm, "submit", this._onFormSubmit.bind(this));
            s(this.searchInput, "blur", this._onInputBlur.bind(this));
            s(this.searchInput, "focus", this._onInputFocus.bind(this));
            s(this.searchReset, "click", this._onInputReset.bind(this));
            s(this.searchInput, "keyup", this._onSearchKeyup.bind(this));
            s(this.searchInput, "keydown", this._onSearchKeydown.bind(this));
            this._searchAction = this.searchForm.getAttribute("action");
            if (!this.searchInput.name) {
                this.searchInput.removeAttribute("name")
            }
        }
        var t = o.prototype = Object.create(n.prototype);
        t._onFormSubmit = function(a) {
            if (!this.inputHasValidText()) {
                q(a)
            }
        };
        t._onInputFocus = function() {
        ...
        t._onInputBlur = function(a) {
            this.trigger("blur")
        };
        t._onInputReset = function(a) {
            q(a);
        ...
        t._onSearchKeydown = function(b) {
            var a = b.keyCode;
            if (a === r.ARROW_DOWN || a === r.ARROW_UP) {
                q(b)
            } else {
                if (a === r.ENTER && !this.inputHasValidText()) {
                    q(b)
                }
            }
        ...
        t.setAutocomplete = function(a) {
            if (!a || a.section !== "suggestions" || a.hover) {
                a = false
            }
            if (!a) {
        ...
        t.inputHasValue = function() {
            return (this.searchInput.value.length && this.searchInput.value.length > 0) ? true : false
        };
        t.inputHasValidText = function() {
            return !this.searchInput.value.match(/^\s*$/)
        };
        t.showSearchReset = function() {
            v.add(this.searchForm, "with-reset")
        };
        t.hideSearchReset = function() {
            v.remove(this.searchForm, "with-reset")
        };
        t.enableSearchReset = function() {
            this.searchReset.disabled = false
        };
        t.disableSearchReset = function() {
            this.searchReset.disabled = true
        };
        t.enableSearchSubmit = function() {
            this.searchSubmit.disabled = false
        };
        t.disableSearchSubmit = function() {
        ...
        t.formatSearchInput = function(a) {
            return encodeURIComponent(a.replace(/[\s\/\'\\]+/g, " ").trim().replace(/\s+/g, "-"))
        };
        x.exports = o
    }, {
        "../helpers/keyMap": 187,
        ...
        "@marcom/ac-dom-events/preventDefault": 21,
        "@marcom/ac-dom-events/utils/addEventListener": 25,
        "@marcom/ac-dom-events/utils/removeEventListener": 26,
        "@marcom/ac-dom-traversal/querySelector": 43,
        "@marcom/ac-event-emitter-micro": 48
    }],
    192: [function(z, A, w) {
        var s = z("@marcom/ac-dom-events/addEventListener");
        var x = z("@marcom/ac-classlist");
        var r = z("@marcom/ac-feature/cssPropertyAvailable");
        ...
        u.remove = function() {
            ...
            x.remove(this.el, q, v, t)
        };
        u._onNextFrame = function() {
            var a;
            if (this._nextFrameCallback) {
                a = this._nextFrameCallback;
                this._nextFrameCallback = null;
                a.call(this)
            }
        };
        u._setNextFrame = function(a) {
            this._nextFrameCallback = a;
            window.requestAnimationFrame(this._onNextFrame)
        };
        u._onAnimationEnd = function(a) {
            if (this._animationEndCheck) {
                if (this._animationEndCheck.call(this, a)) {
        ...
        u._onAnimationEndTimeout = function() {
            clearTimeout(this._animationEndTimeout);
            this._animationEndTimeout = null;
        ...
        u._setAnimationEnd = function(a, b) {
            if (this._animationsAvailable) {
                this._animationEndCheck = b;
                this._animationEndCallback = a;
                this._animationEndTimeout = setTimeout(this._onAnimationEndTimeout, B)
            } else {
                a.call(this)
            }
        };
        u._frameShow = function() {
            this.trigger("showstart");
            x.add(this.el, q);
            this._setAnimationEnd(this._frameAfterShow, this._onShowAnimationEnd)
        };
        u._frameAfterShow = function() {
            x.add(this.el, v);
            x.remove(this.el, q);
            this.trigger("showend")
        };
        u._onShowAnimationEnd = function(a) {
            if (this._viewportEmitter.viewport === "small" || this._viewportEmitter.viewport === "xsmall") {
                return x.contains(a.target, "ac-gn-list")
            }
            return a.animationName === "ac-gn-searchform-slide"
        };
        u._frameHide = function() {
            if (this._animationEndCallback) {
        ...
        u._frameAfterHide = function() {
            x.remove(this.el, t);
            this.trigger("hideend")
        };
        u._onHideAnimationEnd = function(a) {
            if (this._viewportEmitter.viewport === "small" || this._viewportEmitter.viewport === "xsmall") {
                return x.contains(a.target, "ac-gn-list")
            }
            return x.contains(a.target, "ac-gn-search")
        };
        A.exports = C
    }, {
        "@marcom/ac-classlist": 12,
        "@marcom/ac-dom-events/addEventListener": 15,
        "@marcom/ac-event-emitter-micro": 48,
        "@marcom/ac-feature/cssPropertyAvailable": 50
    }],
    193: [function(i, h, g) {
        var f = function() {
            var a = function() {
    ...
    194: [function(n, q, m) {
        n("@marcom/ac-polyfills/JSON");
        n("@marcom/ac-polyfills/Date/now");
        var r = n("ac-ajax-xhr");
        var o = n("ac-mvc-model").Model;
        var k = n("./sectionLabels");
        var p = n("./sectionAnalyticsEvents");

        function s(a) {
            this.requestURL = a
        }
        var l = s.prototype = new o();
        l.requestMethod = "post";
        l.fetchData = function(a) {
            a.query = this._normalizeQuery(a.query);
            if (a.query !== this.lastQuery) {
                this.lastQuery = a.query;
                r[this.requestMethod](this.requestURL, this._getRequestConfiguration(a))
            }
        };
        l._normalizeQuery = function(a) {
            return a.trim().replace(/\s+/g, " ")
        };
        l._getRequestData = function(a) {
        ...
        l._getRequestConfiguration = function(a) {
            this._lastRequestTime = Date.now();
            return {
                complete: this._onFetchComplete.bind(this),
                data: this._getRequestData(a),
        ...
        l._boldQueryTerms = function(a) {
            var b;
            if (!this.lastQuery) {
                return a
            }
            b = new RegExp("(\\b" + this.lastQuery.split(" ").join("|\\b") + ")", "ig");
            return a.replace(b, "<b>$&</b>")
        };
        l._jsonToData = function(u) {
            var f = JSON.parse(u);
            var b = f.results.length;
            var i;
            var d = [];
            var j;
            var c;
            ...
            for (g = 0; g < b; g++) {
                j = f.results[g];
                if (j.sectionResults.length) {
                    i = j.sectionName.toLowerCase();
                    if (this.lastQuery === "" && i === "quicklinks") {
                        i = "defaultlinks"
                    }
                    j.sectionName = i;
                    j.sectionLabel = k[i] || i;
                    j.sectionAnalyticsEvent = p[i];
                    for (h = 0; h < j.sectionResults.length; h++) {
                        j.sectionResults[h].rawLabel = j.sectionResults[h].label;
                        j.sectionResults[h].label = this._boldQueryTerms(j.sectionResults[h].label);
                        j.sectionResults[h].index = h
                    }
                    if (i === "quicklinks") {
                        d.unshift(j)
                    } else {
            ...
            if (d.length) {
                ...
                if (this.lastQuery === "") {
                    ...
                    f.noresults = k.noresults
                }
            }
            f.query = this.lastQuery;
            f.initial = !("results" in this.attributes);
            return f
        };
        l._onFetchSuccess = function(f, b, c, d) {
            var a;
            if (f !== this._lastRequestTime) {
                return
            }
            a = this._jsonToData(b);
            this.set(a);
            this._trigger("fetchdata:success", a)
        };
        l._onFetchError = function(a, b) {
            this._trigger("fetchdata:error", {
                request: a,
                status: b
            })
        };
        l._onFetchComplete = function(a, b) {
        ...
        "./sectionLabels": 198,
        "@marcom/ac-polyfills/Date/now": 75,
        "@marcom/ac-polyfills/JSON": 78,
        "ac-ajax-xhr": 87,
        "ac-mvc-model": 103
    }],
    195: [function(z, A, x) {
        var y = z("@marcom/ac-classlist");
        var v = z("@marcom/ac-dom-events/utils/addEventListener");
        var C = z("@marcom/ac-dom-traversal/querySelectorAll");
        var p = z("@marcom/ac-event-emitter-micro").EventEmitterMicro;
        var B = z("@marcom/ac-dom-events/target");
        var u = z("../../helpers/keyMap");
        var s = z("@marcom/ac-object/clone");
        var q = "ac-gn-searchresults-link";
        var t = "current";
        var r = function(a) {
            p.call(this);
            this.el = a;
            ...
            v(this.el, "mousemove", this._onMouseMove.bind(this));
            v(this.el, "mouseleave", this._onMouseLeave.bind(this))
        };
        var w = r.prototype = Object.create(p.prototype);
        w._onMouseMove = function(c) {
            var a = B(c);
            var b;
            if (y.contains(a, q) && !y.contains(a, t)) {
                this.setSelectedElement(a, true)
            }
        };
        w._onMouseLeave = function(b) {
            var a = B(b);
            if (a === this.el) {
                this.setSelected()
            }
        };
        w.updateSelectableItems = function() {
            var c = C("." + q);
            var a;
            var b;
            this._selectableItems = [];
        ...
        w.getSelectableItems = function() {
            return this._selectableItems
        };
        w.setSelected = function(a, b) {
            a = a || false;
            if (this._selectedItem && this._selectedItem !== a) {
                this._selectedItem.hover = false;
                y.remove(this._selectedItem.element, t)
            }
            if (a) {
                a.hover = !!b;
                y.add(a.element, t)
        ...
        w.setSelectedIndex = function(b, a) {
            this.setSelected(this._selectableItems[b], a)
        };
        w.setSelectedElement = function(a, b) {
            var c;
            for (c = 0; c < this._selectableItems.length; c++) {
                if (this._selectableItems[c].element === a) {
                    this.setSelected(this._selectableItems[c], b);
                    return
                }
            }
        };
        w.getSelected = function() {
        ...
        w._moveUp = function() {
            var a = this.getSelectableItems();
            var b = this.getSelected();
            if (b) {
                if (b.index > 0) {
                    this.setSelected(a[b.index - 1])
                } else {
                    this.setSelected()
                }
            }
        };
        w._moveDown = function() {
            var a = this.getSelectableItems();
            var b = this.getSelected();
            if (b) {
                if (a[b.index + 1]) {
        ...
        "@marcom/ac-dom-events/target": 24,
        "@marcom/ac-dom-events/utils/addEventListener": 25,
        "@marcom/ac-dom-traversal/querySelectorAll": 44,
        "@marcom/ac-event-emitter-micro": 48,
        "@marcom/ac-object/clone": 67
    }],
    196: [function(t, u, r) {
        var o = t("mustache");
        var s = t("@marcom/ac-classlist");
        var n = t("../../../../mustache/results.mustache");
        var l = "with-content";
        var m = "with-content-initial";
        var p = function(a) {
            this.el = a;
            this.visible = false;
        ...
        var q = p.prototype;
        q.render = function(a) {
            if (!a.results && !a.noresults) {
                this.reset()
            } else {
                this.el.innerHTML = o.render(n, a);
                if (!this.visible) {
                    s.add(this.el, l, m);
        ...
        q.reset = function() {
            s.remove(this.el, l, m);
            this.el.innerHTML = "";
            this.visible = false
        };
        q._removeInitial = function() {
            s.remove(this.el, m)
        };
        u.exports = p
    }, {
    ...
    198: [function(g, k, h) {
        var j = document.getElementById("ac-gn-searchresults");
        var i;
        if (j) {
            i = {
                quicklinks: j.getAttribute("data-string-quicklinks"),
                defaultlinks: j.getAttribute("data-string-quicklinks"),
                suggestions: j.getAttribute("data-string-suggestions"),
                noresults: j.getAttribute("data-string-noresults")
            }
        }
        k.exports = i
    }, {}],
    199: [function(C, F, A) {
        C("@marcom/ac-polyfills/Object/keys");
        var s = C("mustache");
        var r = C("../../../mustache/segment.mustache");
        var B = C("@marcom/ac-classlist");
        var y = C("@marcom/ac-dom-events/utils/addEventListener");
        var G = C("@marcom/ac-dom-nodes/hasAttribute");
        var v = C("@marcom/ac-dom-events/preventDefault");
        var w = C("@marcom/ac-dom-events/target");
        var u = "ac-gn-segmentbar-visible";
        var x = "{%STOREFRONT%}";
        var t = "/shop/goto/home";
        var E = "/shop/goto/exitstore";

        function D(a, b) {
            this.el = a;
            this.store = window.acStore;
            this.strings = JSON.parse(this.el.getAttribute("data-strings").replace(/[']/g, '"'));
            this.redirect = G(this.el, "data-redirect");
            this.storeRootPath = "/" + b;
            y(this.el, "click", this._onClick.bind(this))
        }
        var z = D.prototype;
        z._onClick = function(b) {
            var a = w(b);
            if (a.id === "ac-gn-segmentbar-exit") {
        ...
        z._getViewCopyFromSegmentCode = function(a) {
            var c;
            var b;
            if (a in this.strings.segments && this.strings.segments[a]) {
                return this.strings.segments[a]
            }
            c = Object.keys(this.strings.segments);
            for (b = 0; b < c.length; b++) {
                if (a.indexOf(c[b] + "-") === 0 && this.strings.segments[c[b]]) {
                    return this.strings.segments[c[b]]
                }
            }
        ...
        z.show = function(c) {
            ...
            var a;
            if (c.name) {
                b = this.strings.view.replace(x, c.name)
            } else {
                b = this._getViewCopyFromSegmentCode(c.segmentCode)
            }
            a = {
                view: {
                    copy: b,
                    url: "//www.apple.com" + this.storeRootPath + t
                },
                exit: {
                    copy: this.strings.exit,
                    url: "//www.apple.com" + this.storeRootPath + E
                }
            };
            this.el.innerHTML = s.render(r, a);
            B.add(document.documentElement, u)
        };
        z.hide = function() {
            B.remove(document.documentElement, u)
        };
        F.exports = D
    }, {
        ...
        "@marcom/ac-dom-events/target": 24,
        "@marcom/ac-dom-events/utils/addEventListener": 25,
        "@marcom/ac-dom-nodes/hasAttribute": 32,
        "@marcom/ac-polyfills/Object/keys": 80,
        mustache: 182
    }],
    200: [function(d, g, f) {
